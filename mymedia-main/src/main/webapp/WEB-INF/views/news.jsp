...
<div class="post-container">
    <div class="author">
        <img class="avatar" src="${pageContext.request.contextPath}/resources/newsfeed/img/avatar.jpg" alt="Profile Picture">
        <div class="author-name">Kiss Dávid</div>
        <br>
        <p class="author-date">2019. 01. 23.</p>
    </div>
    <div class="content">
        <img class="content" src="${pageContext.request.contextPath}/resources/newsfeed/img/content.jpg" alt="Post Content">
